    ...
    <section className="py-20 bg-gradient-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            <p className="text-2xl text-white/90 mb-4">Got questions?</p>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/20 transition-all duration-300 group">
              <CardContent className="p-6 text-center">
                <MessageCircle className="w-8 h-8 text-blue-vibrant mx-auto mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-semibold mb-2">Let's Chat</h3>
                <p className="text-white/70 text-sm">Schedule a consultation</p>
              </CardContent>
            </Card>
            
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/20 transition-all duration-300 group">
              <CardContent className="p-6 text-center">
                <Send className="w-8 h-8 text-orange-vibrant mx-auto mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-semibold mb-2">Connect</h3>
                <p className="text-white/70 text-sm">Social media & networks</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
              className="bg-green-vibrant hover:bg-green-vibrant/90 text-foreground px-8 py-4 text-lg font-semibold rounded-2xl shadow-glow"
            >
